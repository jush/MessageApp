...
import static org.gdgespoo.cloudendpointsworkshop.backend.OfyService.ofy;
 ...
 */
@Api(name = "registration", version = "v1", namespace = @ApiNamespace(ownerDomain = "backend.cloudendpointsworkshop"
